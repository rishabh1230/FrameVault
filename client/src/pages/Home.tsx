            ...
            <div className="grid md:grid-cols-2 gap-12 items-end">
              <div>
                <p className="text-xl md:text-2xl font-light leading-relaxed text-cinema-text-secondary mb-8">
                  ...
                  <span className="text-xl md:text-2xl font-light leading-relaxed text-cinema-text-secondary mb-8">
                    Experience films as their creators intended.
                  </span>
                </p>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl font-black text-cinema-text-primary mb-8 leading-tight font-montserrat cinema-bg">
              PRESERVING CINEMA
              <span className="block text-cinema-accent font-montserrat cinema-bg">
                FOR FUTURE GENERATIONS
              </span>
            </h2>

            <p className="text-xl text-cinema-text-secondary leading-relaxed mb-8">
              We believe that Indian cinema is an art form worthy of the highest level of respect
              and care. Every release in our collection represents a commitment to quality,
              authenticity, and the preservation of India's rich cinematic heritage across all
